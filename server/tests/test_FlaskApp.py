...
def test_solve_sight(client: 'testing.FlaskClient'):
    ...
    assert json.dumps(p) == '[{"aoe": [145, 171, 195], "attacks": [145, 169], "destinations": [69], "focuses": [145], "move": 69, "sightlines": [[[4.772727272727226, 34.1686386584043], [9.068888888889251, 33.89430980322626]], [[4.758454106280176, 34.193360507875475], [7.766183574879195, 35.91202348311534]]]}]'
