...
def fixture_app_client() -> FlaskClient:
...
def normalize_ranges(ranges: list[list[list[int]]]) -> list[tuple[tuple[int, int], ...]]:
    return sorted(tuple((start, end) for start, end in path) for path in ranges)


def test_isAlive(app_client: FlaskClient):
    response = app_client.get("/isAlive")
    assert response.status_code == 200
    assert b"ok" in response.data


def test_views(app_client: FlaskClient):
...
def test_solve_thin_los(app_client: FlaskClient):
    response = app_client.put(
...
def test_solve_sight(app_client: FlaskClient):
    response = app_client.put(
    ...
    assert normalize_ranges(q) == normalize_ranges([[[13, 23], [37, 42], [43, 48], [63, 69], [70, 73], [88, 95], [96, 97], [114, 115], [116, 122], [139, 146], [165, 171]], [[17, 25], [41, 46], [47, 50], [67, 69], [70, 75], [95, 100], [120, 125], [144, 150], [170, 175]], [[14, 23], [38, 48], [63, 68], [88, 95], [114, 115], [116, 123], [139, 147], [165, 172], [190, 196]], [[17, 25], [41, 50], [70, 71], [72, 75], [95, 100], [120, 125], [144, 150], [169, 175], [194, 199]], [[17, 25], [43, 50], [70, 75], [96, 100], [120, 125], [143, 150], [168, 175], [193, 199], [219, 224]]])
    assert r == 18
    assert normalize_ranges(s) == normalize_ranges([[[0, 42], [43, 69], [70, 95], [96, 115], [116, 122], [123, 148], [149, 187], [188, 260], [261, 332], [333, 405], [406, 477], [478, 550], [551, 725]], [[0, 46], [47, 69], [70, 91], [95, 114], [120, 136], [144, 159], [169, 181], [193, 204], [218, 226], [241, 250], [266, 275], [290, 300], [315, 325], [339, 350], [364, 375], [388, 400], [412, 425], [436, 450], [461, 475], [485, 500], [510, 525], [534, 550], [559, 575], [582, 600], [607, 625], [631, 650], [656, 675], [680, 700], [705, 725]], [[0, 68], [75, 95], [100, 115], [116, 123], [125, 138], [139, 162], [163, 185], [186, 209], [210, 232], [233, 256], [257, 279], [280, 303], [304, 326], [327, 350], [351, 725]], [[0, 50], [70, 71], [72, 75], [95, 100], [120, 125], [144, 150], [169, 175], [192, 200], [217, 225], [241, 250], [266, 275], [289, 300], [314, 325], [338, 350], [363, 375], [386, 400], [411, 425], [435, 450], [460, 475], [483, 500], [508, 525], [532, 550], [557, 575], [580, 600], [605, 625], [629, 650], [654, 675], [677, 700], [702, 725]], [[17, 25], [43, 50], [70, 75], [96, 100], [120, 125], [143, 150], [167, 175], [190, 200], [214, 225], [237, 250], [261, 275], [284, 300], [308, 325], [331, 350], [355, 375], [378, 400], [402, 725]]])

def test_solve_multiple_destination(app_client: FlaskClient):
    response = app_client.put(
...
def test_views_invalid_payload_returns_400(app_client: FlaskClient):
    response = app_client.put("/views", data=b'{"scenario_id":18,"solve_view":2}')
...
def test_solve_invalid_payload_returns_400(app_client: FlaskClient):
